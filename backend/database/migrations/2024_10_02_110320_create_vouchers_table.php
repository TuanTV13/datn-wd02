...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('vouchers', function (Blueprint $table) {
            ...
            $table->double('min_order_value', 10, 2)->nullable()->comment('Giá trị tối thiểu của đơn hàng được áp dụng voucher');
            $table->double('max_order_value', 10, 2)->nullable()->comment('Giá trị tối đa của đơn hàng được áp dụng voucher');
