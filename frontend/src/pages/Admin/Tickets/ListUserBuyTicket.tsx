  ...
  return (
    <div>
        <div className="bg-white rounded-lg shadow">
                <h2 className="text-2xl font-bold text-center">Danh sách người dùng mua vé</h2>
                <div className="p-4 flex justify-between">
                    <div className="flex space-x-4">
                        <button className="bg-blue-500 text-white px-4 py-2 rounded-[10px]">Chờ duyệt</button>
                        <button className="bg-blue-500 text-white px-4 py-2 rounded-[10px]">Đã thanh toán</button>
                        <button className="bg-blue-500 text-white px-4 py-2 rounded-[10px]">Chưa thanh toán</button>
                        <button className="bg-blue-500 text-white px-4 py-2 rounded-[10px]">Đã hủy</button>
                    </div>
                ...
                <table className="min-w-full table-auto border border-gray-700">
                    <thead className="bg-gray-100 text-left items-center text-center">
                        <tr>
                            ...
                            <th className="p-4 border border-gray-300">Phương thức thanh toán</th>
                            <th className="p-4 border border-gray-300">Trạng thái thanh toán</th>
                        </tr>
                    </thead>
