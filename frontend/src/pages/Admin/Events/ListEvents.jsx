...
import { Input, notification, Select } from "antd"; // Sử dụng Ant Design để làm input và select
        ...
        <div className="flex gap-4 mb-6">
          ...
          <Select
            ...
            filterOption={
              (input, option) =>
                input &&
                option?.label.toLowerCase().includes(input.toLowerCase()) // Lọc khi có nhập chữ
            }
