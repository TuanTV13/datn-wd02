    ...
    content: (
      ...
      >
        ...
        <div className="md:w-1/2 lg:ml-10 relative z-10">
          <h1
            className="lg:text-[40px] md:text-5xl font-medium mb-4 text-white transition-all duration-500 ease-in-out transform hover:scale-105"
          >
            {event.name}
          </h1>
          <div className="flex justify-center md:justify-start lg:ml-5">
            <Link
              ...
              className="bg-gradient-to-r from-[#0D6EFD] to-[#6610F2] text-white py-2 px-6 rounded-full hover:bg-gradient-to-r hover:from-[#6610F2] hover:to-[#0DCAF0] shadow-lg transition-all duration-300 transform hover:scale-105"
            >
              Chi tiết sự kiện
            </Link>
          </div>
