  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.access_token) {
        ...
        const response3 = await axiosInstance.get("/user", {
          Headers: { Authorization: response.access_token },
        });
        localStorage.setItem("email", response3?.data?.user?.email);
        localStorage.setItem("id", response3?.data?.user?.id);
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-3 position-relative input-container">
              <input
                ...
                onMouseEnter={() =>
                  errors.password && setShowPasswordError(true)
                }
                onMouseLeave={() =>
            ...
            <div className="form-check mb-3 d-flex align-items-center">
              ...
              <i
                className={`far ${
                  rememberMe ? "fa-check-square" : "fa-square"
                }`}
