...
const ListClient = () => {
  ...
  const [clients, setClients] = useState([]); // Dữ liệu khách hàng từ API
  ...
  const handleDeleteClient = (clientId) => {
    axios
      .delete(`http://127.0.0.1:8000/api/v1/users/${clientId}/delete`, {
        headers: {
          Authorization:
      ...
      .then((response) => {
        // Nếu xóa thành công, cập nhật lại danh sách khách hàng
