  ...
  const route = useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        { path: "/admin/discount-code-list", element: <DiscountCodeList /> },
        { path: "/admin/discount-code", element: <AddDiscountCode /> },
        { path: "/admin/expiring-voucher", element: <ExpiringVoucherForm /> },
      ],
    },
    {
      path: "auth",
